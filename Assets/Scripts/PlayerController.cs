...
public class PlayerController : MonoBehaviour, IMagnetic
{
    ...
    /// </summary>
    bool IsHoldingObjects
    {
        get { return this.attractables.Count > 0; }
    }
    ...
    void SetPlayerAction()
    {
        ...
        this.isAttracting = Input.GetButton("Fire1");//this.dpad.Input["Magnet"] == 1;
    ...
    { 
        ...
        if(this.isAttracting && !this.IsHoldingObjects) {
            ...
            if(Physics.Raycast(ray, out hitInfo, rayDestination, this.attractableLayer)) {
                ...
                if(attractable != null) {
                    ...
                    if(isNew) {
                        ...
                        if(this.IsHoldingObjects) {
                            attractable.InstantAttract(this);
                        } else {
    ...
    void SetInputVector()
    {
        float h = Input.GetAxisRaw("Horizontal");//this.dpad.Input["Horizontal"];
        float v = Input.GetAxisRaw("Vertical");//this.dpad.Input["Vertical"];
    ...
    void Move()
    {
        ...
        // Still Moving
            ...
            this.isMoving = true;
            Vector3 targetDestination = Vector3.MoveTowards(this.transform.position, this.destination, this.speed * Time.deltaTime);
            ...
            foreach(IAttractable attractable in this.attractables) {
                ...
                targetDestination = Vector3.MoveTowards(goTransform.position, targetPosition, this.speed * Time.deltaTime);
